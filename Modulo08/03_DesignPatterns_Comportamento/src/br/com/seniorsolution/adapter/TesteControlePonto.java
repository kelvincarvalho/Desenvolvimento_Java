...
public class TesteControlePonto {
	...
	public static void main(String[] args) throws InterruptedException {
		//PATERN ADAPTER: PERMITE CRIAR UMA SEGUNDA CLASSE CONTENDO AS MESMAS OPREÇÕES DE UMA CLASSE
		//CONTENDO AS MESMAS OPERAÇÕES DE UMA CLASSE TOMADA COMO BASE, MAS UTILIZANDO ELEMENTOS DIFERENTES(ADAPTAVEIS)
		
		//USANDO A CLASSE ORIGINAL
		System.out.println("Classe ControlePonto");
		ControlePonto cp = new ControlePonto();
		Funcionario f= new Funcionario("Kelvin", "Estagiário");
		...
		Funcionario fa= new Funcionario("Kelvin Adapter", "Estagiário");
