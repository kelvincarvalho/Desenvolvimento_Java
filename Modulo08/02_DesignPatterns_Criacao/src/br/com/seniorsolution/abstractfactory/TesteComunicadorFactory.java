...
public class TesteComunicadorFactory {
	...
	public static void main(String[] args) {
		...
		//ABSTRACTFACTORY: permite encapsular a escolha das clsses concretas a serem utilizadas na criacao dos objetos de diversas familias (no caso, VISA OU MATER);
		...
		System.out.println("MASTER: "+mensagem2);
	}
